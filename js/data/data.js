...
var sceneActions = [
	...
	, {'scene':'0', 'action':'battle', 'ememyLevels' : [1], 'enemyArray': ['Goblin', 'Goblin', 'Goblin', 'Goblin'], 'isEscapable':false, 'maxNoOfEmemies':4,'battleId':0 }
...
//from spreadsheet
var sceneMedia = {
	'0' : { 'pic':'res/tavernBG.png', 'music': 'res/sounds/frogsNight.mp3'}
...
var explainData= {
	...
	"explain1" : [
	  { 'bg': 'res/caveBg.png', 'text': 'The cave looked normal outside, but inside was a chamber. Stained glass windows shone like the sun was right outside.', 'sound': '' }
	, { 'bg': 'res/caveBg.png', 'text': 'In front of me: a man? A shadow? I don\t know. But it spoke to me, even knew my name.', 'sound': '' }
	, { 'bg': 'res/caveBg.png', 'text': '  \"I am free, and you can be my first.\" he said. Images flowed through my head - I knew what he meant.', 'sound': '' }
	, { 'bg': 'res/caveBg.png', 'text': 'Power, money, knowledge - he was offering them to me. If I would help him.', 'sound': '' }
	, { 'bg': 'res/caveBg.png', 'text': 'But I read the stories, and I knew the old wizards could never be trusted. I started to back away.', 'sound': '' }
	, { 'bg': 'res/caveBg.png', 'text': 'Then there was a flash of light….', 'sound': '' }
...
var sceneDialog = { 
	...
	, { 'pic': 'res/faces/clavoTalk.png', 'speaker': 'Clavo', 'text': 'I don\'t know. That\'s when the spell must have hit me. The next thing I knew, you were pulling me out of my own grave.', 'sound': '' }
	, { 'pic': 'res/faces/lissetteFrown.png', 'speaker': 'Lissette', 'text': 'The cave, what\'s going on with that? Is the wizard still there? ', 'sound': '' }
	, { 'pic': 'res/faces/clavoFrown.png', 'speaker': 'Clavo', 'text': 'I\'m not supposed to tell you this, but Donte contacted the Grandmarchy. He, Bryce, and Burton went out to look this morning.', 'sound': '' }
	, { 'pic': 'res/faces/mizakTalk.png', 'speaker': 'Mizak', 'text': 'Isn\'t that dangerous? Why aren\'t they waiting for troops to come?', 'sound': '' }
	, { 'pic': 'res/faces/clavoFrown.png', 'speaker': 'Clavo', 'text': 'They\'re just going to mark the site, not go in.', 'sound': '' }
	, { 'pic': 'res/faces/lissetteFrown.png', 'speaker': 'Lissette', 'text': 'Well they ought to be back by now. It\'s dusk.', 'sound': '' }
	, { 'pic': 'res/faces/westonYell.png', 'speaker': 'Weston', 'text': 'Lissette! Customers coming in!', 'sound': '' }
	, { 'pic': 'res/faces/lissetteNormal.png', 'speaker': 'Lissette', 'text': 'I\'ll be right back. Anyone want anything when I\'m done?', 'sound': '' }
	, { 'pic': 'res/faces/lemelNormal.png', 'speaker': 'Lemel', 'text': 'Another dark ale for me.', 'sound': '' }
	, { 'pic': 'res/faces/clavoNormal.png', 'speaker': 'Clavo', 'text': 'Just some ginger beer.', 'sound': '' }
	, { 'pic': 'res/faces/mizakNormal.png', 'speaker': 'Mizak', 'text': 'Some of that berry wine.', 'sound': '' }
	, { 'pic': 'res/faces/lissetteAngry.png', 'speaker': 'Lissette', 'text': 'No, you\'ll have water. Your tab\'s up to five thalers and I\'m not baling you out again.', 'sound': '' }
	, { 'pic': 'res/faces/mizakTalk.png', 'speaker': 'Mizak', 'text': 'C\'mon, don\t be that way, honey. I need something to help me sleep.', 'sound': '' }
	, { 'pic': 'res/faces/lissetteAngry.png', 'speaker': 'Lissette', 'text': 'Don\'t pull that on me! How about if I slam you in the head with this tankard? That ought to put you to sleep.', 'sound': '' }
	, { 'pic': 'res/faces/mizakFrown.png', 'speaker': 'Mizak', 'text': '…water\'s fine.', 'sound': '' }
	, { 'pic': 'res/faces/lemelFrown.png', 'speaker': 'Lemel', 'text': 'I still don\'t like this. What\'s taking the reeve and everyone so long?', 'sound': '' }
	, { 'pic': 'res/faces/clavoFrown.png', 'speaker': 'Clavo', 'text': 'No idea, but-', 'sound': '' }
	, { 'pic': 'res/faces/reeveFrown.png', 'speaker': 'Reeve Donte', 'text': 'Defenses!', 'sound': '' }
	, { 'pic': 'res/faces/blankFace.png', 'speaker': '', 'text': '(Reeve Donte, Bryce, and Burton clamor into the tavern. Bryce nurses a bloody arm)', 'sound': '' }
	, { 'pic': 'res/faces/burtonFrown.png', 'speaker': 'Burton', 'text': 'There\'s goblins after us! Militia up and defend!', 'sound': '' }
	, { 'pic': 'res/faces/bryceAngry.png', 'speaker': 'Bryce', 'text': 'Lemel, they\'re coming straight here!', 'sound': '' }
	, { 'pic': 'res/faces/lemelAngry.png', 'speaker': 'Lemel', 'text': 'I\'m ready.', 'sound': '' }
	, { 'pic': 'res/faces/clavoAngry.png', 'speaker': 'Clavo', 'text': 'Me too.', 'sound': '' }
	, { 'pic': 'res/faces/lemelFrown.png', 'speaker': 'Lemel', 'text': 'Clavo, get behind me. This guys look tough.', 'sound': '' }
	, { 'pic': 'res/faces/clavoAngry.png', 'speaker': 'Clavo', 'text': 'No, I can fight too!', 'sound': '' }
	, { 'pic': 'res/faces/lemelFrown.png', 'speaker': 'Lemel', 'text': 'Not very well.', 'sound': '' }
	, { 'pic': 'res/faces/clavoFrown.png', 'speaker': 'Clavo', 'text': '…', 'sound': '' }
	, { 'pic': 'res/faces/lissetteAngry.png', 'speaker': 'Lissette', 'text': 'Stop it, just get ready. Here they come.', 'sound': '' }
	, { 'pic': 'res/faces/mizakAngry.png', 'speaker': 'Mizak', 'text': '…', 'sound': '' }
	], 
	
	"scene1" : [ 
		{ 'pic': 'res/faces/clavoFrown.png', 'speaker': 'Clavo', 'text': 'Goblins haven\'t attached here since the Horde Wars. What\'s going on?', 'sound': '' }
	], 
